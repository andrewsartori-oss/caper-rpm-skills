---
name: launch-report
description: Generate a comprehensive pre-launch readiness assessment for a specific retailer's next scheduled Caper cart store deployment
...
# Launch Readiness Report Generator

Generate a comprehensive pre-launch readiness assessment for the specified retailer's next scheduled Caper cart store deployment. Assess readiness across all workstreams, check for missing artifacts, flag unresolved dependencies, and generate a launch go/no-go recommendation with evidence.
...
5. **File Creation and Google Doc Upload** - CRITICAL: Save locally AND upload to Google Docs:
   ...
   - After successful upload, create a .webloc shortcut file to the Google Doc in the same folder:
     ...
     - Create a .webloc file with the same base filename: `/Users/andrewsartori/Desktop/launch-report [retailer]/LAUNCH-[retailer]-[store-id]-[MM]-[DD]-[YYYY]-[Time].webloc`
