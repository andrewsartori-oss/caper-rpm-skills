...
5. **File Creation and Google Doc Upload** — Save locally AND upload to Google Docs:
   - Check if the directory exists: `/Users/andrewsartori/Desktop/project-phases [retailer]/`
   - If it doesn't exist, create it: `mkdir -p "/Users/andrewsartori/Desktop/project-phases [retailer]"`
   ...
   - Save the file:
     - **If store ID provided**: `/Users/andrewsartori/Desktop/project-phases [retailer]/project-phases-[retailer]-[store-id]-[MM]-[DD]-[YYYY]-[Time].md`
     - **If no store ID**: `/Users/andrewsartori/Desktop/project-phases [retailer]/project-phases-[retailer]-[MM]-[DD]-[YYYY]-[Time].md`
   - Then upload to Google Docs using the md2doc upload script:
     ```bash
     export PATH="$HOME/.local/bin:$PATH" && cd ~/.claude/plugins/marketplaces/instacart/md2doc/skills/md2doc/scripts/ && uv run python upload-gdoc.py "/Users/andrewsartori/Desktop/project-phases [retailer]/project-phases-[retailer]-[store-id]-[MM]-[DD]-[YYYY]-[Time].md" --title "Project Phases - [Retailer Name] [store-id] ([Month] [Day] [Year])"
     ```
...
- **File naming convention**:
  - With store ID: `project-phases-[retailer]-[store-id]-[MM]-[DD]-[YYYY]-[Time].md`
  - Without store ID: `project-phases-[retailer]-[MM]-[DD]-[YYYY]-[Time].md`
  - Time format: 24-hour clock with timezone (e.g., "2000EST", "0945PST")
- **Folder naming convention**: `project-phases [retailer]`
- **Save location**: `/Users/andrewsartori/Desktop/project-phases [retailer]/`
- **Google Doc title format**:
  - With store ID: `Project Phases - [Retailer Name] [store-id] ([Month] [Day] [Year])`
  - Without store ID: `Project Phases - [Retailer Name] ([Month] [Day] [Year])`
